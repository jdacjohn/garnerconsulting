...
// Buffer the data
ob_start();
readfile($pixopoint_codingengine.'/data.php?id='.get_option('pixo_saved')); // load from external server
...
// Buffer the CSS
ob_start();
readfile($pixopoint_codingengine.'/style.php?id='.get_option('pixo_saved')); // load from external server

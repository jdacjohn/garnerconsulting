							...
							<td class="desc">
								...
								<?php
									if (get_option('suckerfish_menucontents') != '') {
										$temp = explode('|', get_option('suckerfish_menucontents'));
										foreach ($temp as $set) {
											if ($XXX != 1) {
												$set = explode('=', $set);
...
<div id="listItem_pages" class="pixo_widget">
	...
	<div id="pulldown_pages2" class="dropdown">
		<p>
			...
			<input class="titlewidthinput" type="text" name="suckerfish_pagestitle" value="<?php echo get_option('suckerfish_pagestitle'); ?>" />
			<br />
			<label id="titlewidthlabel"><?php _e('URL','pixopoint_menu_lang'); ?></label>
			<input class="titlewidthinput" type="text" name="suckerfish_pagesurl" value="<?php echo get_option('suckerfish_pagesurl'); ?>" />
			<label><?php _e('IDs to include or exclude','pixopoint_menu_lang'); ?></label>
			<input class="shortwidthwidget" type="text" name="suckerfish_excludepages" value="<?php echo get_option('suckerfish_excludepages'); ?>" />
			&nbsp; &nbsp; &nbsp;
			...
			<input class="titlewidthinput" style="width:140px;" type="text" name="suckerfish_pagesnoparentlinks" value="<?php echo get_option('suckerfish_pagesnoparentlinks'); ?>" />
		</p>
	</div>
</div>
...
<div id="listItem_categories" class="pixo_widget">
	...
	<div id="pulldown_pages" class="dropdown">
		<p>
			...
			<input class="titlewidthinput" type="text" name="suckerfish_categoriestitle" name="suckerfish_categoriestitle" value="<?php echo get_option('suckerfish_categoriestitle'); ?>" />
			<br />
			<label id="titlewidthlabel">URL</label>
			<input class="titlewidthinput" type="text" name="suckerfish_categoriesurl" value="<?php echo get_option('suckerfish_categoriesurl'); ?>" />
			<label style="clear:left">IDs to include or exclude</label>
			<input class="shortwidthwidget" type="text" name="suckerfish_excludecategories" value="<?php echo get_option('suckerfish_excludecategories'); ?>" />
			&nbsp; &nbsp; &nbsp;
...
<div id="listItem_recentcomments" class="pixo_widget">
	...
	<div id="pulldown_pages5" class="dropdown">
		<p>
			...
			<input class="titlewidthinput" type="text" name="suckerfish_recentcommentstitle" value="<?php echo get_option('suckerfish_recentcommentstitle'); ?>" />
			<br />
			<label id="titlewidthlabel">URL</label>
			<input class="titlewidthinput" type="text" name="suckerfish_recentcommentsurl" value="<?php echo get_option('suckerfish_recentcommentsurl'); ?>" />
		</p>
	</div>
</div>
<script type="text/javascript">
...
?>
				...
				<table class="widefat" cellspacing="0" id="active-plugins-table">
					<thead>
						<tr>
							<th scope="col"><?php _e('Menu design','pixopoint_menu_lang'); ?></th>
						</tr>
					</thead>
					<tfoot>
						<tr>
<?php /*
							<th scope="col"><?php _e('You can either disable the editing pane by using the close (X) button on the editor itself, or by disabling it here in the admin page.','pixopoint_menu_lang'); ?></th>
*/ ?>
							<th scope="col">
								<?php _e('Apologies. There was originally an option here to edit your menu via an easy to use editing panel on your site. Unfortunately there was a few too many bugs in our implementation of this feature and we have had to remove it temporarily till we fix the errors. There was a small possibility of a security vulnerability which we are working on fixing. We released a security patch in version 0.6.14 which mostly fixed this problem, but in the interests of maxiumum security we have disabled this feature until we rewrite the section of the plugin. Apolgies again for the inconvenience.','pixopoint_menu_lang'); ?>
								<br /><br />
								<?php _e('In the mean time, we have a CSS generator available on our site which can perform the same task ... <a href="http://pixopoint.com/suckerfish_css/">CSS generator</a>. Simply copy and paste the CSS from that page and paste it into the CSS section in this plugin.','pixopoint_menu_lang'); ?>
							</th>
						</tr>
					</tfoot>
					<tbody class="plugins">
						<tr class="inactive">
							<td class="desc">
                      			<label>Enable editing pane?</label>
								<?php /*
									<input type="checkbox" name="enableeditingpane" <?php if (get_option('enableeditingpane') == 'on') {echo ' checked="checked"';} ?>" />
								*/ ?>
								<br /><br /><br />
							</td>
						</tr>

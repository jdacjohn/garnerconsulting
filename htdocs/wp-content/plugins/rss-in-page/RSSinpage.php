...
if ($rssfeed != 'no feed') { 
$rssformatsplit = str_split($rssformat);
$rssformatdef = array('x','y','Y','z');
...
$Y = '<a href="'.$rss_itemlink.'" target="'.$rsstarget.'" title="'.$rsslinketitle.'">'.$rsstitle.'</a>'; } else { $Y = $rsstitle; }

...
Now supports multiple feed URLs separated by commas e.g. rssfeed='feedurl1, feedurl2' 

Optional attributes: 

* rssformat allows you to format the output using format parameters e.g. the default x: Y - z where x is the date, Y is the title with a link, y is the title, z is the description.
